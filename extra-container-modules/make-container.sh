...
$([ "amd64" = "$GITEA_ARCH" ] && echo qemu-system-x86 || :) qemu-user-static opendkim opendkim-tools geoip-database gnupg libfcgi-bin ovmf dnsmasq-base unbound \\
qemu-utils sa-compile shared-mime-info spamc curl cgit python3-markdown python3-pygments rsyslog iptables docker.io docker-compose wireguard-tools && \\
