...
qemu-utils sa-compile shared-mime-info spamc curl cgit fcgiwrap python3-markdown rsyslog && \
...
RUN wget -O /gitea.xz https://dl.gitea.io/gitea/1.14.1/gitea-1.14.1-linux-amd64.xz && \
	mkdir /extras && \
